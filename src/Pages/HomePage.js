      ...
      <section className="promo">
        <div className="promo-slider">
          <div className="promo-slider__item promo-slider__item--style-1">
            <picture>
              <source
                srcset={require("../img/promo_1.jpg").default}
                media="(min-width: 835px)"
              />
              <source srcset={{ slide }} media="(min-width: 376px)" />
              <img className="img--bg" src={{ slide }} alt="img" />
            </picture>
                    ...
                    <div className="align-container__item">
                      ...
                      <div className="promo-slider__wrapper-2">
                        <p className="promo-slider__subtitle">
                          Charitable ventures for greater giving Gloal impact
                          works on Charitble ventures to inspeire greater
                          giving.Firoz kunnamparambil foundations serves a
                          charity among public sectors.
                        </p>
                      </div>
          ...
          <div className="promo-slider__item promo-slider__item--style-2">
            <picture>
              ...
              <img className="img--bg" src="img/375promo_2.jpg" alt="img" />
            </picture>
            <div className="container">
              <div className="row">
                <div className="col-xl-7">
                  <div className="align-container">
                    <div className="align-container__item">
                      ...
                      <div className="promo-slider__wrapper-2">
                        <p className="promo-slider__subtitle">
                          Our commitment is to entitle children to become a
                          catalyst in transforming lives by developing life
                          skills to build better future with focus and a
                          determined goal. This helps to build their
                          self-confidence and to understand their abilities.
                        </p>
                      </div>
                      <div className="promo-slider__wrapper-3">
                        <a
          ...
          <div className="promo-slider__item promo-slider__item--style-3">
            <picture>
              ...
              <img className="img--bg" src="img/375promo_3.jpg" alt="img" />
            </picture>
            <div className="container">
              <div className="row">
                  ...
                  <div className="align-container">
                    <div className="align-container__item">
                      <div className="promo-slider__wrapper-1">
                        <h2 className="promo-slider__title">
                          <span>
                            Firoz kunnamparambil Foundation Volounteers
                          </span>
                          <br />
                          <span>Around the world.</span>
                        </h2>
                      ...
                      <div className="promo-slider__wrapper-2">
                        <p className="promo-slider__subtitle">
                          Firoz Kunnamparambil Foundation's Home for Children is
                          registered under provisions of sections (41)1 of the
                          Juvenile Justice Act, 2015 as Child Care Institution.
                          We Provide Free Education, Shelter and Clothing for
                          the Children.
                        </p>
                      </div>
                      <div className="promo-slider__wrapper-3">
        ...
        <ul className="promo-socials">
          <li className="promo-socials__item">
            <a className="promo-socials__link" href="#">
        ...
        <div className="promo-pannel">
          ...
          <div className="promo-pannel__phones">
            ...
            <a className="promo-pannel__link" href="tel:+18009756511">
              + 1800 - 975 65 11
            </a>
          </div>
          <div className="promo-pannel__email">
            <p className="promo-pannel__title">Email</p>
            <a className="promo-pannel__link" href="mailto:support@helpo.org">
